...
rule gunzip:
    ...
    Copy local peptide files to resources folder to include them in ortholog inference step.
    """
    input:
    ...
    params:
        sarsia_proteins="../sarsia/results/reference/Trinity_20210112_longestORFperGene.pep",
        tripedalia_proteins="../tripedalia/results/reference/GHAQ01.1.fsa_nt.fasta.fixed_longestORFperGene.pep",
    ...
    shell:
        ...
        cp {params.sarsia_proteins} resources/sequences/Sarsia_tubulosa.pep.fasta
        cp {params.tripedalia_proteins} resources/sequences/Tripedalia_cystophora.pep.fasta
...
rule orthofinder:
    ...
    Concatenate all gene trees into a master text file.
    """
    input:
        expand("resources/sequences/{species}.pep.fasta", species=targets.index)
    output:
        "results/annotations/gene_trees.master.txt"
    conda:
    ...
    shell:
        ...
        dir=results/orthofinder/Results_*/Gene_Trees
